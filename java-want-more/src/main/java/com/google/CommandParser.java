    ...
    switch (command.get(0).toUpperCase()) {
      ...
      case "PLAY_PLAYLIST":
        try {
          ...
          System.out.println("Please enter PLAY_PLAYLIST command followed by a " +
                  "playlist name");
        }
        break;
      case "NEXT":
  ...
  private void getHelp() {
    String helpText =
        "Available commands:\n"
            ...
            + "    PLAY_PLAYLIST <playlist_name> - Plays specified playlist.\n"
            + "    NEXT - Plays next video in playlist.\n"
            + "    SHOW_CURRENT_PLAYLIST - Plays specified playlist.\n"
            + "    HELP - Displays help.\n"
